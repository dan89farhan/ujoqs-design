...
<html lang="{{ config('app.locale') }}">
    ...
    <div class="amit-container">
        ...
        <a href="app"><div class="col-sm-2 category block-2" id="home">Home</div></a>
        <a href="app"><div class="col-sm-2 category block-3" id="jokes">Jokes</div></a>
        <a href="app"><div class="col-sm-2 category block-4" id="shayari">Shayari</div></a>
        <a href="app"><div class="col-sm-2 category block-5" id="quotes">Quotes</div></a>
