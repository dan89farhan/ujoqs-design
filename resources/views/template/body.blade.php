...
a{
    ...
    <body>
<link rel="stylesheet" href="<?php echo asset('css/body.css')?>" type="text/css">
<!-- <div class="category-btn">Category</div> -->
<div id="page" class="container" style="height:auto; width: 70%;">
<script type="text/javascript">

</script>
@include('template.upload')

<div class="col-sm-4 div-hider" style="height: 400px;float:right; margin-top: 58px;">
	<ul class="listed-cat">
		<li class="category">APJ Abdul Kalam Quotes</li>
		<li class="category">Jokes</li>
		<li class="category">Shayari</li>
		<li class="category">Quotes</li>
		<li class="category">Santa Banta Jokes</li>
	</ul>
</div>
